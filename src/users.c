...
static char rcsid[] = "$Id: users.c,v 1.5 2002/03/05 19:17:57 kiavik Exp $";
...
int user_find(char*req_name, char*auth_name, VALUE_PAIR**check_pairs, 
	      VALUE_PAIR**reply_pairs,USER_FILE user_desc)
{
